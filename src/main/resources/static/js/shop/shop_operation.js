...
$(function () {
    ...
    //如果能从URL里获取shopId，则表示要进行店铺信息修改，反之进行店铺注册
    if (!isEdit){
        //店铺注册
        getShopInitInfo();
    } else {
    ...
    /**
     * 通过店铺Id从后端获取店铺信息，然后填充到前端页面中，方便对店铺信息进行修改
     * @param shopId
     */
    ...
    $('#submit').click(function () {
        ...
        formData.append('shopStr',JSON.stringify(shop)); //JSON.stringify()方法用于将json对象转换为json字符串
